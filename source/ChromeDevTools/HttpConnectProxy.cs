    ...
    public class HttpConnectProxy : ProxyConnectorBase
    {
        ...
        public override void Connect(EndPoint remoteEndPoint)
        {
            ...
            try
            {
                ...
                ProxyEndPoint.ConnectAsync(ProcessConnect, null);
#endif
            }
            catch (Exception e)
            {
        ...
        //Socket socket, object state, SocketAsyncEventArgs e
        protected void ProcessConnect(Socket socket, object state, SocketAsyncEventArgs e)
        {
            ProcessConnect(socket, e.RemoteEndPoint, e, null);
        }
